...
/**
  ...
  from observed dependent property changes, then mapped with the mapping function
  the Ember object.
  @method computedObservable
  @param mapFn {Function} the mapping function that receives a hash of dependent properties
